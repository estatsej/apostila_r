...
Outros dispositivos gráficos além das janelas externas mencionadas são os dispositivos gráficos de arquivos que serão explicados na [próxima seção](#exportando-gráficos).
